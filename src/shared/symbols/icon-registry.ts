...
export const ICON_REGISTRY: Record<string, CrossPlatformSymbol> = {
  ...
  'square.grid.2x2.fill': icon('square.grid.2x2.fill', 'grid_view'),
  ...
  'storefront.fill': icon('storefront.fill', 'store'),
  'frying.pan.fill': icon('frying.pan.fill', 'skillet'),
  'shield.fill': icon('shield.fill', 'shield'),
  'bolt.fill': icon('bolt.fill', 'bolt'),
  'lock.fill': icon('lock.fill', 'lock'),
